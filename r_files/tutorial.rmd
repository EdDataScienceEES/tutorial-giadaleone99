...
R is very powerful due to its wide applications in statistics, mdoelling, data visualisation and spatial data. In this tutorial we will be focussing on spatial data. 
